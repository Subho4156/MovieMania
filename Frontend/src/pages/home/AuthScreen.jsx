...
const AuthScreen = () => {
  ...
  return (
    <div className='hero-bg relative'>
      ...
      <div className='h-2 w-full bg-[#252525]' aria-hidden='true'></div>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
          ...
          <div className='flex-1 md:text-left text-centre'>
      ...
      <div className='py-10 bg-black text-white'>
        <div className='flex max-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2'>
          <div className='flex-1 relative'>
            <img src="/kids.png" alt="Enjoy on your tv" />
          </div>
          <div className='flex-1 text-center md:text-left'>
            <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Create profiles for kids</h2>
            <p className='text-lg md:text-xl'>
              Send kids on adventures with their favorites characters in a space made just for them-free with your membership.
            </p>
          </div>
        </div>
      </div>
